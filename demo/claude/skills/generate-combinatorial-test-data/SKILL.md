...
description: Sinh test data cho ma trận kết hợp đa chiều bằng pipeline chạy thật qua nhiều modules. Dùng đầu ra từ skill generate-cross-module-test-plan làm input.
---
...
> - **Skill:** `.agents/skills/test-data-generator/SKILL.md` — Quy tắc sinh data (xem phần Multi-Step Pipeline)
> - **Skill:** `.agents/skills/ui-debug-agent/SKILL.md` — Inspect DOM khi chạy browser
> - **Workflow:** `.agents/skills/generate-cross-module-test-plan/SKILL.md` — Hiểu cấu trúc ma trận đầu vào
