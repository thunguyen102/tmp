...
> - **Skill:** `.agents/skills/requirements-analyzer/SKILL.md` — Phân tích requirements
...
| Tình huống | Dùng? |
|------------|-------|
| Tính năng đi qua **1 module/form** | ❌ Dùng `$generate-manual-testcases-rbt` |
...
|----------|-------------------|
| Sinh **test cases chi tiết** cho từng bộ kết hợp | `$generate-manual-testcases-rbt` — input = ma trận |
