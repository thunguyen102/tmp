...
Kỹ năng này hướng dẫn Codex chuyển đổi giao diện UI hoặc cấu trúc DOM/HTML của một trang web thành tài liệu yêu cầu rõ ràng, chi tiết cho QA, Tester và Developer.
