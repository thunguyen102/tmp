...
> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`$requirements-analyzer`** (tại `.agents/skills/requirements-analyzer/SKILL.md`) để hiểu cách phân tích yêu cầu chuẩn trước khi bắt đầu.
...
| Cần sinh test cases bài bản (RBT 6 bước) | `$generate-manual-testcases-rbt` |
