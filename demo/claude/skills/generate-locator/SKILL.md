...
# $generate-locator — Sinh Locator Ổn Định Cho UI Automation
...
> - **Skill:** `.agents/skills/smart-locator-agent/SKILL.md` — Quy trình sinh locator
> - **Skill:** `.agents/skills/ui-debug-agent/SKILL.md` — Quy trình inspect DOM
> - **Rule:** `.agents/rules/locator_strategy.md` — Bản đồ ưu tiên locator
> - **Rule:** `.agents/rules/<framework>_rules.md` — Quy tắc riêng framework đang dùng
